...
class _ContentPageState extends State<ContentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: blocRadioProgramas.subject.stream,
          builder:
                    ...
                    Positioned(
                        ...
                        Column(
                          ...
                          child: Container(
                              ...
                              width: size.width, height: size.width * 0.1,
                      ...
                      Container(
                          padding: EdgeInsets.only(top: (page == 1)?(size.width * 0.2):(size.width * 0.3), bottom: (page == infoModel.pages)?0:(size.width * 0.1)),
